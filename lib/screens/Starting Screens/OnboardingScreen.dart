  ...
  final List<Map<String, String>> onboardingPages = [
    {
      ...
      'description':
          'Join us in making the world greener by adopting eco-friendly habits. Discover daily tips for sustainable living.',
      'image': '🌱' // You can replace with an actual image if you want
    },
    {
      'title': 'Daily Eco Tips',
      'description':
          'Get personalized recommendations to reduce your carbon footprint and live more sustainably every day.',
      'image': '💡'
    },
    {
      'title': 'Track Your Impact',
      'description':
          'Monitor your progress and see how small changes make a big difference for our planet.',
      'image': '📊'
    }
  ];
